  ...
  render: function(){
    ...
    return <div className="col-md-4 col-md-offset-4">
        ...
        <div className="text-center">
          <h1 className="login-brand-text">Electronics Universe - Central Station</h1>
          <h3 className="text-muted">Created by <a href="http://startreact.com">electronicsuniverse.com</a> team</h3>
        </div>
